...
async fn test_parse_real_document_json() {
  ...
  let json_path = unzip_path.join("collab_jsons/documents/b8f96497-c880-4fea-8232-c31d57daab83.json");
  ...
  let document = remapper.build_document("test-document-id").unwrap();
