use crate::core::collab::make_yrs_doc;
use crate::core::origin::CollabOrigin;
use crate::core::transaction::DocTransactionExtension;
use crate::entity::CollabType;
use crate::plugins::local_storage::indexeddb::kv_impl::CollabIndexeddb;
use crate::plugins::local_storage::kv::PersistenceError;
use crate::plugins::local_storage::kv::keys::{make_doc_state_key, make_state_vector_key};
