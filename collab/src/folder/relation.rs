...
use crate::preclude::{Any, MapExt, MapRef, YrsValue};
use crate::preclude::{Array, ArrayRef, ReadTxn, TransactionMut};
...
pub struct ViewIdentifier {
  pub id: crate::entity::uuid_validation::ViewId,
}

impl Deref for ViewIdentifier {
  type Target = crate::entity::uuid_validation::ViewId;
...
impl ViewIdentifier {
  pub fn new(id: crate::entity::uuid_validation::ViewId) -> Self {
    Self { id }
  }
