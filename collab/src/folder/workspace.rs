...
use super::{RepeatedViewIdentifier, View, ViewLayout, timestamp};

#[derive(Clone, Debug, Serialize, Deserialize, Eq, PartialEq)]
pub struct Workspace {
  pub id: crate::entity::uuid_validation::WorkspaceId,
  pub name: String,
...
impl Workspace {
  pub fn new(id: crate::entity::uuid_validation::WorkspaceId, name: String, uid: i64) -> Self {
    let time = timestamp();
    Self {
      id,
      name,
