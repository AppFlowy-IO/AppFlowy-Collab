use crate::preclude::{Any, Array, ArrayRef, Map, MapExt, MapRef, ReadTxn, YrsValue};
use anyhow::bail;
use serde::{Deserialize, Serialize};

use super::FAVORITES_V1;
use super::{Folder, ParentChildRelations, SectionItem, ViewId, Workspace};
...
struct TrashRecord {
  pub id: ViewId,
  #[serde(deserialize_with = "crate::preclude::deserialize_i64_from_numeric")]
  pub created_at: i64,
  #[serde(default)]
