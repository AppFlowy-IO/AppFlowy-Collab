...
use yrs::{
  Any, Array, ArrayPrelim, ArrayRef, DeleteSet, Doc, Map, MapPrelim, MapRef, Observable, Origin,
  Out, Subscription, Transact, TransactionMut,
};
...
impl PermanentUserData {
  ...
  pub fn map_user<S: Into<UserDescription>>(
    ...
    self.users.observe_with("pud", move |txn, e| {
