...
use crate::database::meta::MetaMap;
...
use crate::database::views::define::DATABASE_VIEW_ROW_ORDERS;
...
use crate::entity::define::{DATABASE, DATABASE_ID, DATABASE_METAS};
...
use crate::util::{AnyExt, ArrayExt};
...
use crate::database::database_trait::{
  DatabaseCollabService, DatabaseDataVariant, DatabaseRowCollabService,
};
...
pub fn gen_row_id() -> crate::entity::uuid_validation::RowId {
  uuid::Uuid::new_v4()
}
...
impl DatabaseBody {
  ...
  pub fn from_collab(
    ...
    let database_id = crate::entity::uuid_validation::try_parse_database_id(&database_id_str)?;
