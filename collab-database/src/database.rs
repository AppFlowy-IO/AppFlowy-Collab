...
use crate::fields::{
  type_option_cell_reader, Field, FieldChangeReceiver, FieldMap, FieldUpdate, TypeOptionCellReader,
};
...
impl Database {
  ...
  pub fn get_stringify_type_option(&self, field_id: &str) -> Option<Box<dyn TypeOptionCellReader>> {
    let txn = self.collab.transact();
